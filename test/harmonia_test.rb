...
class HarmoniaTest < Test::Unit::TestCase
  ...
  def test_sends_mail_to_drinks_assignee_after_assignment
    @harmonia.assign(:drinks)

    assert Mail::TestMailer.deliveries.find { |m| m.subject =~ /it's your turn to organise drinks.$/ }
  end
